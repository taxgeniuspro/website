...
async function sendTestEmail() {
  const firstName = 'Ira';
  const trackingCode = 'iw';
  const avatarUrl = 'https://res.cloudinary.com/dhktmiigh/image/upload/v1765487892/taxgeniuspro/preparers/preparer_ow.png';
...
`;
  ...
  console.log('Sending test email to iradwatkins@gmail.com...');

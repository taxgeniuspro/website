...
async function sendRetryEmails() {
  console.log('=== RETRYING FAILED EMAILS (10 preparers) ===\n');
  ...
  for (const preparer of preparers) {
    ...
    // Longer delay to avoid rate limiting - 1 second between each
...
sendRetryEmails().catch(console.error);

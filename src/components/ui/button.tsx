...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: 'h-11 px-4 py-2', // 44px - meets touch target requirements
        sm: 'h-10 px-3 text-xs', // 40px - acceptable minimum
        lg: 'h-12 px-8 text-base',
        xl: 'h-14 px-10 text-lg',
        icon: 'h-11 w-11', // 44px square - meets touch target
        'icon-sm': 'h-10 w-10', // 40px square for compact areas
      },
    },
    defaultVariants: {
      variant: 'default',

...
/**
 * Marketing Hub Tabs Component
 * Client component wrapper for Marketing Hub tabs with dynamic content
 */
...
import { ReferralImagesTab } from './ReferralImagesTab';
  ...
  return (
    <Tabs defaultValue="materials" className="space-y-4">
      <TabsList className="flex-wrap h-auto gap-1">
        ...
        <TabsTrigger value="ai-images" className="flex items-center gap-1.5">
          <Sparkles className="h-3.5 w-3.5" />
          AI Images
        </TabsTrigger>
        <TabsTrigger value="referral-images" className="flex items-center gap-1.5">
      ...
      <TabsContent value="referral-images">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Users className="h-5 w-5 text-blue-500" />
              Referral Images Management
            </CardTitle>
            <CardDescription>
              Manage promotional images for tax preparers and their referral campaigns
            </CardDescription>
          </CardHeader>

        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.resend.com https://www.google-analytics.com https://api.stripe.com https://connect.squareup.com https://pci-connect.squareup.com https://res.cloudinary.com wss:",
              "frame-src 'self' https://js.stripe.com https://web.squarecdn.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",

    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://js.stripe.com https://web.squarecdn.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "img-src 'self' data: blob: https: http:",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://supabase.taxgeniuspro.tax https://api.resend.com https://www.google-analytics.com https://api.stripe.com https://connect.squareup.com https://pci-connect.squareup.com https://res.cloudinary.com wss:",
              "frame-src 'self' https://js.stripe.com https://web.squarecdn.com https://accounts.google.com https://supabase.taxgeniuspro.tax",
              "object-src 'none'",
              "base-uri 'self'",
